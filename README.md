...
```bash
git clone https://github.com/worldwonderer/video-recap.git ~/.claude/skills/video-recap
```
...
所有 prompt 模板在 `references/prompt-templates.md`，直接编辑即可调整解说风格和质量。
